...
\begin{center}
    \includegraphics[width=0.9\textwidth]{../figures/devtime-bxpall.pdf} \\
    \includegraphics[width=0.9\textwidth]{../figures/devtime-bxpline.pdf} \\
    \includegraphics[width=0.9\textwidth]{../figures/devtime-bxprep.pdf}    
\end{center}

\begin{minipage}{\linewidth}\verbatiminput{../figures/devtime-model.txt}\end{minipage}
...
\begin{center}
    \includegraphics[width=\textwidth]{../figures/lifespan-ts.pdf}
\end{center}
\begin{center}
    \includegraphics[width=\textwidth]{../figures/lifespan-dist.pdf}
\end{center}

\begin{minipage}{\linewidth}\verbatiminput{../figures/lifespan-model.txt}\end{minipage}

\subsection{Proportional hazards (Cox) model}

\begin{center}
    \includegraphics[width=\textwidth]{../figures/lifespan-tscox.pdf}
\end{center}

\begin{minipage}{\linewidth}\verbatiminput{../figures/lifespan-modelcox.txt}\end{minipage}
